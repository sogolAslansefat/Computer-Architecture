module IF_Stage(
    ...
    adder ADDM(32'd4, pcOut, PC);

    mux2to1 mux(PC, BranchAdd, Branch_taken, muxout);
...
module InstructionMemory(
    ...
    always @(PC)begin 
        Inst = 32'b111111_00001_00010_00000_00000000000;
        case (PC)
            ...
            default: Inst = 32'b1110_00_1_1101_0_0000_0000_000000010100;     //MOV R0 ,#20       //R0 = 20
        endcase
    end
endmodule